    ...
    <head>  
	 ...
	 <?php  			
				...
				if(isset($_POST['envoyer1']) ){
					if ( isset($_POST['envoyer1']) && $_SESSION['erreur'] == 1 )
						$_SESSION['nbpage'] = 1;
					else if ( isset($_POST['envoyer1']) && $_SESSION['erreur'] != 1 )
						    $_SESSION['nbpage'] = 3;
					...
					if ( $erreur != 0 )
						...
						$_SESSION['nbpage'] = 5;
				}elseif(isset($_POST['suivantC'])){
					$_SESSION['nbpage'] = 5;
				}elseif(isset($_POST['precedentC'])){
					$_SESSION['nbpage'] = 3;
				}elseif(isset($_POST['envoyer3'])){
					$_SESSION['nbpage'] = 6;
				}elseif(isset($_POST['suivantD'])){
					$_SESSION['nbpage'] = 7;
				}elseif(isset($_POST['precedentCur'])){
					$_SESSION['nbpage'] = 5;
				}elseif(isset($_POST['envoyer4'])){
					$_SESSION['nbpage'] = 7;
				}
	        	       
	if($_SESSION['nbpage'] == 1) {   ?>
		  ...
		  <!----------------------------------------------------------- Debut section une -------------------------------------------------------------> 
	                     ...
	                     <tr><td>
		                     ...
		                     <tr><td align="right"><strong>  <font face="Arial" size="3"> Nom </font> </strong> </td>  <td><strong>  <font face="Arial" size="3">  :</font> </strong> </td>
							         <td> <?php $_SESSION['form1']['nom']=$_POST['nom']; if((!empty($_SESSION['form1']['nom']))) echo $_SESSION['form1']['nom']; else{ echo "Erreur";$_SESSION['erreur']=1; $_SESSION['nbpage'] = 1;echo'<a href="index.php"> Retour </a>' ; }  ?> </td> </tr>  
		                     <tr><td align="right"><strong>  <font face="Arial" size="3"> Pr&eacute;nom </font> </strong></td><td><strong>  <font face="Arial" size="3">  :</font> </strong></td> </font> </strong>  
							         <td> <?php  $_SESSION['form1']['prenom']=$_POST['prenom']; if((!empty($_SESSION['form1']['prenom']))) echo $_SESSION['form1']['prenom']; else{ echo "Erreur";$erreur=1; echo'<a href="index.php"> Retour </a>' ; }  ?>  </tr>
			                 <tr><td align="right"><strong>  <font face="Arial" size="3"> Date de naissance </font> </strong></td> <td><strong>  <font face="Arial" size="3">  :</font> </strong></td> </font> </strong> 
							         <td>  <?php  $_SESSION['form1']['date']=$_POST['date']; if((!empty($_SESSION['form1']['date']))) echo $_SESSION['form1']['date']; else{ echo "Erreur";$erreur=1; echo'<a href="index.php"> Retour </a>' ; }  ?></tr> 
			                 <tr><td align="right"><strong>  <font face="Arial" size="3"> Lieu de naissance </font> </strong></td> <td><strong>  <font face="Arial" size="3">  :</font> </strong></td> </font> </strong> 
							         <td>  <?php  $_SESSION['form1']['lieunaiss']=$_POST['lieunaiss']; if((!empty($_SESSION['form1']['lieunaiss']))) echo $_SESSION['form1']['lieunaiss']; else{ echo "Erreur";$erreur=1; echo'<a href="index.php"> Retour </a>' ; }  ?> </tr> 
							 </table>
                        </table>
	 ...
	 <!--------------------- Tableau principal --------------------------->
		 ...
		 <!------------------------------------- Tableau de la section 2 ----------------------------------------->
		  ...
		  <!------------------------------------- Debut section deux ----------------------------------------->
						 ...
						 <tr><td align="center"><input type="submit" name="envoyer2" /></td></tr>	
                    </table>
			<form/>
			</table>
		 <!-------------------------------- Fin section deux ----------------------------------->
                          ...
                          <tr>
                        	<td colspan="2" align="center">
                        		<form method="post" action="">
                        			<input type="submit" name="precedentC" value="précédent">
                   	    			<input type="submit" name="suivantC" value="suivant">
                  				</form>
                        	</td>
                        </tr>
                    </table>
	 ...
	 <!--------------------- Tableau principal --------------------------->
		...
		<!----------------------------------------- Debut section trois --------------------------------------->
				      ...
				      <!----------------------------------------- Cycle universitaire --------------------------------------->        
					   ...
					   <tr><td align="center"><input type="submit" name="envoyer3" /></td></tr>
                   </table>				     
			<form/>	
 
 		<?php }
		else if($_SESSION['nbpage']== 6){
		...
		<!----------------------------------------- Debut section trois --------------------------------------->
	                     ...
	                     <tr><td>
		                      ...
		                      <ol>
								<li>  <font face="Arial" size="3"><strong>  Cycle Primaire </strong></font> 			              
									<ul type="disc"><li> <font face="Arial" size="3"><strong>  Ecole : </strong></font>  
									                       <?php 
									                        if($primaire != "") echo $primaire; else{ echo "Erreur"; echo'<a href="index.php"> Retour </a>' ; }  ?>
												    </li>
												    <li> <font face="Arial" size="3"><strong>  Ann&eacute;e de d&eacute;but : </strong></font> 
													       <?php if($adprimaire != "") echo $adprimaire; else{ echo "Erreur"; echo'<a href="index.php"> Retour </a>' ; }  ?>
													</li>
													<li> <font face="Arial" size="3"><strong>  Ann&eacute;e de fin : </strong></font>
														   ...
														   //vérifier si l'année de début du cycle primaire plus la durée est au moins égale à l'année de fin du cycle primaire
  													       $verifp = $adprimaire + 6 ;
  													       if($afprimaire >= $verifp && $afprimaire <= $adcem) echo $afprimaire; else{ echo "Erreur ann&eacute;e incorrecte"; echo'<a href="index.php"> Retour </a>' ; }  ?>
													</li>
									</ul>
								</li>			 
				              ...
				              <li>  <font face="Arial" size="3"><strong> Cycle Moyen </strong></font> 			      				      
								<ul><li>  <font face="Arial" size="3"><strong> CEM : </strong></font>  
								          <?php if($cem != "") echo $cem; else{ echo "Erreur"; echo'<a href="index.php"> Retour </a>' ; }  ?>
									</li>
									<li>  <font face="Arial" size="3"><strong> Ann&eacute;e de d&eacute;but : </strong></font>
 									      <?php if($adcem != "") echo $adcem; else{ echo "Erreur"; echo'<a href="index.php"> Retour </a>' ; }  ?>
									</li>
									<li>  <font face="Arial" size="3"><strong> Ann&eacute;e de fin : </strong></font>
 									      <?php 
										   //vérifier si l'année de début du cycle moyen plus la durée est au moins égale à l'année de fin du cycle moyen
 									      $verifc = $adcem + 4 ;
 									      if($afcem >= $verifc && $afcem <= $adlycee) echo $afcem; else{ echo "Erreur ann&eacute;e incorrecte"; echo'<a href="index.php"> Retour </a>' ; }  
 									      ?>
									</li>
								</ul>
					          </li>
				              ...
				              <li>   <font face="Arial" size="3"><strong> Cycle Secondaire </strong></font> 				             
								<ul type="square">
									<li>   <font face="Arial" size="3"><strong> Lycee : </strong></font>  
									       <?php if($lycee != "") echo $lycee; else{ echo "Erreur"; echo'<a href="index.php" > Retour </a>' ; }  ?>
								    </li>
									<li>   <font face="Arial" size="3"><strong> Ann&eacute;e de d&eacute;but : </strong></font>
									       <?php if($adlycee != "") echo $adlycee; else{ echo "Erreur"; echo'<a href="index.php"> Retour </a>' ; }  ?>
									</li>  
									<li>   <font face="Arial" size="3"><strong> Ann&eacute;e de fin : </strong></font> 
									       <?php 
										   //vérifier si l'année de début du cycle secondaire plus la durée est au moins égale à l'année de fin du cycle secondaire
									       $verifl = $adlycee + 3 ;
									       if($aflycee >= $verifl && $aflycee <= $adfac) echo $aflycee; else{ echo "Erreur ann&eacute;e incorrect"; echo'<a href="index.php"> Retour </a>' ; }  ?>
									</li> 
									<li>   <font face="Arial" size="3"><strong> Bac : </strong></font> 
										<dl>
											<dt><p><strong> S&eacute;rie: </strong></p>
												<dd> <?php if($serie != "") echo $serie; else{ echo "Erreur"; echo'<a href="index.php"> Retour </a>' ; }  ?>
											<dt><p><strong> Mention: </strong></p>
												<dd> <?php if($mention != "") echo $mention; else{ echo "Erreur"; echo'<a href="index.php"> Retour </a>' ; }  
											...
											<dt><p><strong> Moyenne: </strong></p>
												<dd><?php
														...
														if ($t)
															...
															else{ echo "Erreur"; echo'<a href="index.php"> Retour </a>' ; }
														else{
															echo "Erreur Format" ;echo'<a href="index.php"> Retour </a>' ;
														}
													  ?>
										</dl>		
									</li>
				             ...
				             <li>   <font face="Arial" size="3"><strong> Cycle Universitaire </strong></font> 			             			     
								<ul><li>   <font face="Arial" size="3"><strong> Ann&eacute;e de d&eacute;but : </strong></font>
								               <?php if($adfac != "") echo $adfac; else{ echo "Erreur"; echo'<a href="index.php"> Retour </a>' ; }  ?>
     								</li> 
									<li>   <font face="Arial" size="3"><strong>  Titre P.F.E : </strong></font>  
									           <?php if($pfe != "") echo $pfe; else{ echo "Erreur"; echo'<a href="index.php"> Retour </a>' ; }  ?>  
									</li>
								</ul>
							 </li>
			                 </ol>
                       ...
                       <tr>
                        	<td colspan="2" align="center">
                        		<form method="post" action="">
                        			<input type="submit" name="precedentCur" value="précédent">
                   	    			<input type="submit" name="suivantD" value="suivant">
                  				</form>
                        	</td>
                        </tr>
                   </table>
